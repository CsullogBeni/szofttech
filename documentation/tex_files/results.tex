...
The KPI is calculated as the percentage of core features implemented out of the total planned features. \\
We have defined the features with 12 use cases. All the planned use cases have been implemented successfully, so our KPI can be calculated in this way:
\[ \frac{implemented\ use\ cases}{planned\ use\ cases} * 100 = \frac{12}{12}*100 = 100 \]

It follows that we our KPI is 100\% and our target was to achieve 100\%, therefore we have successfully completed our goal.
